...
;;
;; []<> (or (elev_req f1) (elev_req f2)) 
;; -> []<> (or (not (elev_req f1)) (elev_loc f1)) && []<> (or (not (elev_req f2)) (elev_loc f2)))  
;; 
;; Single line specification (for GAVS+ to parse)
;; []<> (or (elev_req f1) (elev_req f2) ) -> []<> (or (not (elev_req f1)) (elev_loc f1)) && []<> (or (not (elev_req f2)) (elev_loc f2)) 
;;
